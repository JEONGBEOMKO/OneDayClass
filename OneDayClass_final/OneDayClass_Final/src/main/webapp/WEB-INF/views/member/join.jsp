...
<div class="wrapper">
   ...
   <div class="main-signup">
        ...
        <header>
            <!--NAVER LOGO-->
            <div class="logo">
                <a href="/main" target="_blank"><img src="/resources/img/Logo6.png" width="200" class="image"></a>
            </div>
        </header>
		...
		<form id="join_form" method="post">
            <div>
                ...
                <span class="signup-input">
                    <input class="id_input" name="memberId" id="signup-id" type="text"></input>
            ...
            <div style="margin-top: 35px;">
                ...
                <h3>이름</h3>
                <span class="signup-input">
                    <input class="user_input" name="memberName" id="signup-name" type="text"></input>
                </span>
                ...
                <span class="signup-input">
                    <input id="signup-email" type="text" placeholder="이메일을 입력하세요"></input>
                </span>
            ...
            <div style="margin-top: 35px;">
                ...
                <div class="mail_check_wrap" style="display: flex;">
              
                    <span class="signup-input" style="width:100%; margin: 10px 0px 0px 0px">
                        <input  class="mail_input"name="memberMail" id="signup-phone" type="text" placeholder="이메일을 입력하세요"></input>
                    </span>
                  ...
                  <!--   <span class="cnum-btn-wrap">
                    ...
                    <!-- cnum-btn-wrap -->
                    <div class="mail_check_button"> <!-- 원래 span이었음 --><!-- <div class="mail_check_input_box"></div> -->
                        <div class="cnum-btn">인증번호 받기</div> <!-- 원래 button이었음 -->
                    </div>
            ...
            <div>
                <!--가입하기-->
                <div class="signup-btn-wrap">
                    <button class="join_button" id="signup-btn">가입하기</button>
                </div>
            </div>
		</form>
        ...
        <!--<div class="under-login">
            <span class="stay-check">
                ...
                <label for="stay-checkbox" id="stay-text">크리에이터로 가입하기</label>
            </span>
