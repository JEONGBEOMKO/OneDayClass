...
<div class="content_area">
         <div class="content_subject"><span><i class="fa fa-shopping-cart"></i> 장바구니</span></div>
         <!-- 장바구니 리스트 -->
                  ...
                  <c:forEach items="${cartInfo}" var="ci">
                     <tr>
                        <td class="td_width_1 cart_info_td">
                           ...
                           <input type="hidden" class="individual_bookPrice_input" value="${ci.class_price}">
                           ...
                           <input type="hidden" class="individual_totalPrice_input" value="${ci.salePrice * ci.class_count}">
                           <input type="hidden" class="individual_point_input" value="${ci.point}">
                           <input type="hidden" class="individual_totalPoint_input" value="${ci.totalPoint}">
                        </td>
                        <td class="td_width_2"><a href="/detail/${ci.class_id}"><img src="${pageContext.request.contextPath}/resources/upload/${ci.class_thumb_filename}" alt="" width="100px" height="100px"></a></td>
                        <td class="td_width_3"><a href="/detail/${ci.class_id}">${ci.class_name}</a></td>
                        <td class="td_width_4 price_td">
                           <del>정가 : <fmt:formatNumber value="${ci.class_price}" pattern="#,### 원" /></del><br>
                        ...
                        <td class="td_width_4 table_text_align_center">
                           <div class="table_text_align_center quantity_div">
                              <input type="text" value="${ci.class_count}" class="quantity_input">   
                        ...
                        <td class="td_width_4 table_text_align_center">
                           <fmt:formatNumber value="${ci.salePrice * ci.class_count}" pattern="#,### 원" />
                        </td>
                        <td class="td_width_4 table_text_align_center delete_btn2">
                           ...
                           <button class="delete_btn" data-cartId="${ci.cartId}">삭제</button>
                              <input type="hidden" name="cartId" value="${ci.cartId}">
                  ...
                  <tr>
                     <td>
                        <table class="table_under">
                           ...
                           <tr>
                              <td>총 주문 상품수</td>
                              <td>선택한 강좌 <span class="totalKind_span"></span>개 / 총 수량 <span class="totalCount_span"></span>개</td>
                           </tr>
                        </table>
                     </td>
<!--                      <td>
                     ...
                     <td>
                        <table>
                           <tbody>
                              <tr>
                                 <td>
                                    <strong class="strong_ft">총 결제 예상 금액</strong>
                                 </td>
                                 <td>
                     ...
                     <td>
                        <table>
                           <tbody>
                              <tr>
                                 <td>
                                    <strong class="strong_ft">총 적립 예상 마일리지</strong>
         ...
         <form action="/cart/update" method="post" class="quantity_update_form">
            ...
            <input type="hidden" name="class_count" class="update_class_count">
            <input type="hidden" name="memberId" value="${member.memberId}">
         </form>
