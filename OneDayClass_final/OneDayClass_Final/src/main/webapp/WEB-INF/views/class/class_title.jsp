    ...
    <div class="header">
        <div class="container">
            ...
            <div class="progress" style="height: 5px;">
                <div class="progress-bar" role="progressbar" style="width: 20%; background-color: #98B6EC;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <!-- /PROGRESS BAR -->
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="col-md-9">
                <form>
                    ...
                    <div class="container">
                        <div class="regis_title">
                            <h1>클래스 제목을 입력해주세요</h1>
                        </div>
                        <div class="regis-box">
                            <input class="input" placeholder="클래스 제목을 입력해주세요"><br>
                        </div>
                    </div>
                    <br>
                    <!-- /TITLE -->
                    ...
                    <div class="container">
                        <div class="regis_title">
                            <h1>클래스를 짧게 요약해주세요</h1>
                        </div>
                        <div class="regis-box">
                            &nbsp;이 강의는 <input class="input3" placeholder="명사형으로 입력해주세요"> 클래스 입니다<br>
                        </div>
                    </div>
                    <br>
                    <!-- /TITLE -->
                    ...
                    <div class="container">
                        <div class="regis_title">
                            <h1>썸네일 이미지를 올려주세요</h1>
                        </div>
                        <div class="regis-box">
                            <div id="preview" >이미지 미리보기</div>
                            <label for="file" class="btn_basic">파일 업로드</label>
                            <input type="file" name="file1" id="file" onchange="handleFileSelect(event)" accept="image/*"> <br>
                        </div>
                    </div>
                    <!-- /IMAGE -->
                </form>
                ...
                <div class="pagination">
                    <a href="class_info"><button type="button" class="btn_next" value="next">다음</a>
                    <!-- <a class="btn_next" href="class_info.html" role="button">다음</a> -->
                </div>
                <!-- /NEXT -->
            </div>
        </div>
